...
public class OpencvActivity extends AppCompatActivity implements OnTouchListener, CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tts=new TextToSpeech(OpencvActivity.this, new TextToSpeech.OnInitListener() {
            @Override
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        touch_color.setText("#" + String.format("%02X", (int)mBlobColorRgba.val[0])
        ...
        if(touch_color.getText().toString().equals("#000000")) {
                tts.speak("The signal color is green so wait for 60 seconds", TextToSpeech.QUEUE_FLUSH, null);


        }else{
            tts.speak("The signal color is red and you can cross the intersection now", TextToSpeech.QUEUE_FLUSH, null);
